...
public class DesktopAccountBuilder extends AccountBuilder {
	...
	private DesktopAccountBuilder() {}; //use the ctor with params please
	
	public DesktopAccountBuilder(CoreClientFactory clientFactory, ClickHandler signInHandler, ClickHandler signUpHandler, ClickHandler editProfileHandler, ClickHandler signOutHandler) {
