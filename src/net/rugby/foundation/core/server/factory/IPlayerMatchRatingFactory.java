...
public interface IPlayerMatchRatingFactory {
	...
	IPlayerMatchRating getNew(IPlayer playerId, IMatchGroup matchId, Integer rating, IRatingEngineSchema schemaId, IPlayerMatchStats playerMatchStatsId, String details);
