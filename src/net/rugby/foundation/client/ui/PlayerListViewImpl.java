...
//		int i = 0;
//		if (numColumns == 6)
//			playersTable.setHTML(0, i++, "<img src='resources/cb.jpg'>");
//		playersTable.setText(0, i++, "Name");
//		playersTable.setText(0, i++, "Rating");
//		playersTable.setText(0, i++, "Last");
//		playersTable.setText(0, i++, "Position");
//		playersTable.setText(0, i++, "Team");
		playersTable.getRowFormatter().addStyleName(0, "groupListHeader");
	...
	public void setListener(Listener<T> listener) {
		...
		PlayerListViewColumnDefinitions.setListener((Listener<PlayerRowData>) listener);
