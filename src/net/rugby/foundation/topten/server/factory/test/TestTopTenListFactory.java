...
public class TestTopTenListFactory extends BaseTopTenListFactory implements ITopTenListFactory {
	...
	private List<ITopTenItem> getItems(TopTenList list ) {
		...
		if (list.getId().equals(1000L)) {
			...
			items.add(new TopTenItem(1000007L, 9001019L, pf.get(9001019L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit,", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.CENTER, list, null, 500 ));
			...
			items.add(new TopTenItem(1000017L, 9001019L, pf.get(9001019L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit,", null, 1L, 1L, true, "http://google.com","New Zealand", 9001L,  position.CENTER, list, null, 500 ));
			...
			items.add(new TopTenItem(r.nextLong(), 9002001L, pf.get(9002001L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ", null, 1L, 1L, false, "http://google.com", "Australia", 9002L,  position.CENTER, list, null, 500 ));
			items.add(new TopTenItem(r.nextLong(), 9001019L, pf.get(9001019L), "", null, 1L, 1L, false, "http://google.com", "New Zealand", 9001L,  position.CENTER, list, null, 500));
	...
	private List<ITopTenItem> getListOfItemsForSimpleList(TopTenList list) {
		List<ITopTenItem> items = new ArrayList<ITopTenItem>();
		items.add(new TopTenItem(1000000L, 9002002L, pf.get(9002002L), "", null, 1L, 1L, true, "http://google.com", "Australia", 9002L, position.CENTER, list, null, 500 ));
		items.add(new TopTenItem(1000001L, 9001014L, pf.get(9001014L), "", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.PROP, list, null, 500 ));
		items.add(new TopTenItem(1000002L, 9002012L, pf.get(9002012L), "", null, 1L, 1L, true, "http://google.com", "Australia", 9002L,  position.LOCK, list, null, 500 ));
		items.add(new TopTenItem(1000003L, 9001002L, pf.get(9001002L), "", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.CENTER, list, null, 500 ));
		items.add(new TopTenItem(1000004L, 9002017L, pf.get(9002017L), "", null, 1L, 1L, true, "http://google.com", "Australia", 9002L,  position.WING, list, null, 500 ));
		items.add(new TopTenItem(1000005L, 9001009L, pf.get(9001009L), "", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.FLANKER, list, null, 500 ));
		items.add(new TopTenItem(1000006L, 9002006L, pf.get(9002006L), "", null, 1L, 1L, true, "http://google.com", "Australia", 9002L,  position.FLANKER, list, null, 500 ));
		items.add(new TopTenItem(1000007L, 9001019L, pf.get(9001019L), "", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.CENTER, list, null, 500 ));
		items.add(new TopTenItem(1000008L, 9002004L, pf.get(9002004L), "", null, 1L, 1L, true, "http://google.com", "Australia", 9002L,  position.HOOKER, list, null, 500 ));
		items.add(new TopTenItem(1000009L, 9001001L, pf.get(9001001L), "", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.SCRUMHALF, list, null, 500 ));
