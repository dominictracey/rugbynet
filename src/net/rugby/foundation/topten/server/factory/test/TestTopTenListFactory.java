...
public class TestTopTenListFactory extends BaseTopTenListFactory implements ITopTenListFactory {
	...
	private List<ITopTenItem> getItems(TopTenList list) {
		...
		if (list.getId().equals(1000L)) {
			...
			items.add(new TopTenItem(1000007L, 9001019L, pf.getById(9001019L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit,", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.CENTER, list));
			...
			items.add(new TopTenItem(1000017L, 9001019L, pf.getById(9001019L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit,", null, 1L, 1L, true, "http://google.com","New Zealand", 9001L,  position.CENTER, list));
			...
			items.add(new TopTenItem(r.nextLong(), 9002001L, pf.getById(9002001L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ", null, 1L, 1L, false, "http://google.com", "Australia", 9002L,  position.CENTER, list));
			items.add(new TopTenItem(r.nextLong(), 9001019L, pf.getById(9001019L), "", null, 1L, 1L, false, "http://google.com", "New Zealand", 9001L,  position.CENTER, list));
