...
public class TestTopTenListFactory extends BaseTopTenListFactory implements ITopTenListFactory {
	...
	public TestTopTenListFactory(IPlayerFactory pf, ICompetitionFactory cf, IMatchGroupFactory mf, ITeamGroupFactory tf, IRoundFactory rf, 
			...
			ISocialMediaDirector smd, INotesCreator nc, IRatingSeriesFactory rsf, IUniversalRoundFactory urf, INoteFactory nf, IRatingMatrixFactory rmf, IRatingGroupFactory rgf, ITeamGroupFactory tgf) {
...
//		}
	...
	private List<ITopTenItem> getItems(TopTenList list ) {
		...
		place.setCompId(1L);
		place.setSeriesId(75000L);
		place.setGroupId(76000L);
		place.setMatrixId(77100L);
		place.setQueryId(7710001L);
		
		if (list.getId().equals(1000L)) {
			items.add(new TopTenItem(1,1000000L, 9002002L, pf.get(9002002L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", null, 1L, 1L, true, "http://google.com", "Australia", 9002L, position.CENTER, list, null, 1500, place.getGuid()));
			items.add(new TopTenItem(2,1000001L, 9001014L, pf.get(9001014L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.CENTER, list, null, 1500, place.getGuid() ));
			items.add(new TopTenItem(3,1000002L, 9002012L, pf.get(9002012L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", null, 1L, 1L, true, "http://google.com", "Australia", 9002L,  position.CENTER, list, null, 500, place.getGuid() ));
			items.add(new TopTenItem(4,1000003L, 9001002L, pf.get(9001002L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.CENTER, list, null, 500, place.getGuid() ));
			...
			items.add(new TopTenItem(8,1000007L, 9001019L, pf.get(9001019L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit,", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.CENTER, list, null, 500, place.getGuid() ));
			items.add(new TopTenItem(9,1000008L, 9002004L, pf.get(9002004L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", null, 1L, 1L, true, "http://google.com", "Australia", 9002L,  position.CENTER, list, null, 50, place.getGuid() ));
			items.add(new TopTenItem(10,1000009L, 9001001L, pf.get(9001001L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.CENTER, list, null, 50, place.getGuid()));
		} else if (list.getId().equals(1001L)) {
			items.add(new TopTenItem(1,1000010L, 9002007L, pf.get(9002007L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", null, 1L, 1L, true, "http://google.com", "Australia", 9002L,  position.CENTER, list, null, 1050, place.getGuid()));
			...
			items.add(new TopTenItem(8,1000017L, 9001019L, pf.get(9001019L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit,", null, 1L, 1L, true, "http://google.com","New Zealand", 9001L,  position.CENTER, list, null, 500, place.getGuid() ));
			...
			items.add(new TopTenItem(1,r.nextLong(), 9002007L, pf.get(9002007L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", null, 1L, 1L, false, "http://google.com", "Australia", 9002L,  position.CENTER, list, null, 500, place.getGuid() ));
			...
			items.add(new TopTenItem(7,r.nextLong(), 9002001L, pf.get(9002001L), "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ", null, 1L, 1L, false, "http://google.com", "Australia", 9002L,  position.CENTER, list, null, 500, place.getGuid() ));
			items.add(new TopTenItem(8,r.nextLong(), 9001019L, pf.get(9001019L), "", null, 1L, 1L, false, "http://google.com", "New Zealand", 9001L,  position.CENTER, list, null, 500, place.getGuid()));
	...
	private List<ITopTenItem> getListOfItemsForSimpleList(TopTenList list) {
		...
		place.setMatrixId(77100L);
		place.setQueryId(7710001L);
		items.add(new TopTenItem(1,1000000L, 9002002L, pf.get(9002002L), "", null, 1L, 1L, true, "http://google.com", "Australia", 9002L, position.CENTER, list, null, 500, place.getGuid() ));
		items.add(new TopTenItem(2,1000001L, 9001014L, pf.get(9001014L), "", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.PROP, list, null, 500, place.getGuid() ));
		items.add(new TopTenItem(3,1000002L, 9002012L, pf.get(9002012L), "", null, 1L, 1L, true, "http://google.com", "Australia", 9002L,  position.LOCK, list, null, 500, place.getGuid() ));
		items.add(new TopTenItem(4,1000003L, 9001002L, pf.get(9001002L), "", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.CENTER, list, null, 500, place.getGuid() ));
		items.add(new TopTenItem(5,1000004L, 9002017L, pf.get(9002017L), "", null, 1L, 1L, true, "http://google.com", "Australia", 9002L,  position.WING, list, null, 500, place.getGuid() ));
		items.add(new TopTenItem(6,1000005L, 9001009L, pf.get(9001009L), "", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.FLANKER, list, null, 500, place.getGuid() ));
		items.add(new TopTenItem(7,1000006L, 9002006L, pf.get(9002006L), "", null, 1L, 1L, true, "http://google.com", "Australia", 9002L,  position.FLANKER, list, null, 500, place.getGuid() ));
		items.add(new TopTenItem(8,1000007L, 9001019L, pf.get(9001019L), "", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.CENTER, list, null, 500, place.getGuid() ));
		items.add(new TopTenItem(9,1000008L, 9002004L, pf.get(9002004L), "", null, 1L, 1L, true, "http://google.com", "Australia", 9002L,  position.HOOKER, list, null, 500, place.getGuid() ));
		items.add(new TopTenItem(10,1000009L, 9001001L, pf.get(9001001L), "", null, 1L, 1L, true, "http://google.com", "New Zealand", 9001L,  position.SCRUMHALF, list, null, 500, place.getGuid() ));
