...
public class FeatureListActivity extends AbstractActivity implements FeatureListViewPresenter, Presenter  {
...
//									clientFactory.getHeaderView().setContent(clientFactory.getContentList(), clientFactory.getLoginInfo().isTopTenContentEditor());
	...
	@Override
	public void edit(ITopTenList list) {
...
//
	public static native void loadWYSIWYGEditor(String text) /*-{
    	...
    	$wnd.LazyLoad.js(["/theme/js/editor/bootstrap3-wysihtml5.js","wysihtml5-0.3.0.js"], function() {
    			//files all loaded
    			alert(text);
  			});
	}-*/;
