 ...
 */
@WithTokenizers({ FeatureListPlace.Tokenizer.class, ContentPlace.Tokenizer.class, SeriesPlace.Tokenizer.class, LegacyListPlace.Tokenizer.class, Profile.Tokenizer.class })
