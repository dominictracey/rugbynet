...
public interface ICoreRuleFactory {
	...
	enum MatchRule { MATCH_TO_LOCK, STALE_MATCH_NEED_ATTENTION, STALE_MATCH_TO_MARK_UNREPORTED, MATCH_TO_END, MATCH_TO_FINAL, MATCH_STATS_AVAILABLE, MATCH_STATS_FETCHED, MATCH_STATS_CLEANSED, MATCH_TO_RATE, MATCH_TO_PROMOTE, LINEUPS_AVAILABLE };
