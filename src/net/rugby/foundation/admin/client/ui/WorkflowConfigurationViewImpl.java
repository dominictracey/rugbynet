...
public class WorkflowConfigurationViewImpl extends Composite implements WorkflowConfigurationView {
	...
	public WorkflowConfigurationViewImpl() {
...
//		wfclistener.saveWorkflowConfiguration(wfConfig);
	...
	/* (non-Javadoc)
	 * @see net.rugby.foundation.admin.client.ui.WorkflowConfigurationView#setCompetitions(java.util.List, java.util.List)
	 */
	@Override
...
//			compTable.setWidget(row,0,initiated);
	...
	/* (non-Javadoc)
	 * @see net.rugby.foundation.admin.client.ui.WorkflowConfigurationView#showStatus(java.lang.String)
	 */
	@Override
